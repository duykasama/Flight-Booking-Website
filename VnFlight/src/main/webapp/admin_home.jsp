                                                    ...
                                                    <form action="#">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" id="fullname" class="form-control bltext" disabled="disabled" placeholder="Administrator">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" id="fullname" class="form-control bltext" disabled="disabled" placeholder="Admin@gmail.com">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                <label for="fullname">Phone</label>
                                                                <input type="text" id="fullname" class="form-control bltext" disabled="disabled" placeholder="0123456789">
                                                            </div>
                                                        </div>
