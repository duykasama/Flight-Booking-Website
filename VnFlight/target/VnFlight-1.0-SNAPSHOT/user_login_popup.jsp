        ...
        <div id="page">
            ...
            <div class="container" id="container">
                <div class="form-container sign-up-container">
                    <c:url var="signUpLink" value="${request.contextPath}/UserAccessController/signupPopup"/>
                ...
                <div class="form-container sign-in-container">
                    <c:url var="loginLink" value="${request.contextPath}/UserAccessController/loginPopup"/>
