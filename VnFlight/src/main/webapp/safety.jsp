                        ...
                        <div class="right">
                            ...
                            <nav>
                                <ul id="menu">
                                    ...
                                    <li id="menu_active"><a href="safety.jsp">Safety</a></li>
                        ...
                        <form id="form_1" action="#" method="post">
                          ...
                          this.value = 'Enter City or Airport Code'" onFocus="if (this.value == 'Enter City or Airport Code')
                            ...
                            this.value = 'mm/dd/yyyy '" onFocus="if (this.value == 'mm/dd/yyyy ')
                                    ...
                                    <div class="bg right">
                                        <input type="text" class="input input2" value="12:00am" onBlur="if (this.value == '')
                            this.value = '12:00am'" onFocus="if (this.value == '12:00am')
                                        this.value = ''">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wrapper">
                                <p>Passenger(s):</p>
                                <div class="bg left">
                                    <input type="text" class="input input2" value="# passengers" onBlur="if (this.value == '')
                          this.value = '# passengers'" onFocus="if (this.value == '# passengers')
                                      this.value = ''">
                                </div>
