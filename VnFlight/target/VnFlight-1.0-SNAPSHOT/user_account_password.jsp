                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-content-inner active" data-content="signup">
                                                    ...
                                                    <c:url var="editUserLink" value="${request.contextPath}/UserAccessController/editPassword"/>
                                                    <form  action="${editUserLink}" name="" method="POST">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <a href="${pageContext.request.contextPath}/user_account_password.jsp" >Cancel</a>
                                                                <br><a href="${pageContext.request.contextPath}/user_account.jsp" >Back</a></br>
                                                                <c:if test="${not empty password_msg}" >
                                                                    <p style="color: ${password_msg_color};">${password_msg}</p>
                                                                </c:if>
                                                                </form>	
                                                            </div>
